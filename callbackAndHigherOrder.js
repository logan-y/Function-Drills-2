...
const multiply = (firstNum, secondNum, callback) => {
...
const contains = (arr3, name4, callback4) => (arr3.includes(name4) ? callback4(true) : callback4(false))
...
console.log(uniq(names, callback5)); 
/*
